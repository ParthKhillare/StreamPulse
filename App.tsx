...
const DbtViewer = React.lazy(() => import('./components/DbtViewer'));
const ConsultantChat = React.lazy(() => import('./components/ConsultantChat'));
const PortfolioOverlay = React.lazy(() => import('./components/PortfolioOverlay'));
        ...
        <Suspense fallback={
          ...
          {(() => {
            switch (activeTab) {
              ...
              case 'lineage': 
                return <div className="p-8 h-full"><LineageGraph /></div>;
              case 'dbt': 
                return <DbtViewer />;
              case 'consultant': 
                return <div className="p-8 h-full"><ConsultantChat /></div>;
              case 'quality': 
                return (
                        ...
                        <div className="bg-slate-900 text-white p-8 rounded-2xl shadow-xl h-96 overflow-hidden">
                          ...
                          <ResponsiveContainer width="100%" height="65%">
                            <AreaChart data={trendData}>
                              ...
                              <YAxis axisLine={false} tickLine={false} tick={{fill: '#94a3b8', fontSize: 10}} tickFormatter={(v: any) => `${v}%`} />
                              <Tooltip 
